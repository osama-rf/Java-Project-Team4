    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav">
                ...
                <li class="nav-item px-2">
                    <a href="/dashboard/items" class="nav-link active">
                        <c:choose>
                            <c:when test="${lang.equalsIgnoreCase('en')}">
                                Items
                            </c:when>
                        ...
                        <c:forEach var="item" items="${items}">
                            <tr>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${lang.equalsIgnoreCase('en')}">
                                            <c:out value="${item.name_en}"/>
                                        </c:when>
                                        <c:otherwise>
                                            <c:out value="${item.name_ar}"/>
                                        </c:otherwise>
                                    </c:choose>
                                </td>
                                <td>
                                    ...
                                    <c:forEach var="category" items="${item.categories}">
                                        <li>
                                            <c:set var="menu" value="${category.menu}"/>
                                            <c:choose>
                                                <c:when test="${lang.equalsIgnoreCase('en')}">
                                ...
                                <td>
                                    <f:formatDate pattern="yyyy-MM-dd hh:mm:ss" value="${item.createdAt}"/>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
