              ...
              <c:when test="${login}">
                <div class="card-body">
                  ...
                  <form:form action="/login" method="post" modelAttribute="login">
                    ...
                    <div class="form-group">
                      <form:input path="password" type="password" class="form-control form-control-lg" placeholder="Password"/>
                    </div>
                    <input type="submit" value="Login" class="btn btn-outline-light btn-block mb-3">
                    <a class="text-white" href="/home/register">Create an account</a>
                  </form:form>
                </div>
              </c:when>
              <c:otherwise>
                <div class="card-body">
                  ...
                  <form:form action="/register" method="post" modelAttribute="register">
                    ...
                    <div class="form-group">
                      <form:input path="lastName" type="text" class="form-control form-control-lg" placeholder="Last Name" />
                    </div>
                    <div class="form-group">
                      <form:input path="email" type="email" class="form-control form-control-lg" placeholder="Email" />
                    </div>
                    ...
                    <div class="form-group">
                      <form:input path="confirm_password" type="password" class="form-control form-control-lg" placeholder="Confirm Password" />
                    </div>
                    <input type="submit" value="Submit" class="btn btn-outline-light btn-block mb-3" />
                    <a class="text-white" href="/home/login">Have an account? Login</a>
                  </form:form>
                </div>
              </c:otherwise>
            </c:choose>
...
<section id="explore-section" class="bg-light text-muted py-5">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <img src="imgs/explore-section1.jpg" alt="" class="img-fluid mb-3 rounded-circle">
      </div>
      <div class="col-md-6">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 order-2">
        <img src="imgs/create-section1.jpg" alt="" class="img-fluid mb-3 rounded-circle">
      </div>
